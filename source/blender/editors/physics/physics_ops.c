...
static void operatortypes_pointcache(void)
{
  ...
  // Perfect World : bphys files cache -- add pointcache manually operator
  WM_operatortype_append(PTCACHE_OT_restore_bake);
  WM_operatortype_append(PTCACHE_OT_manual_delete_bake);
}

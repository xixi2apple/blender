                            ...
                            const TaskParallelTLS *__restrict UNUSED(tls))
{
  ...
  // Perfect World : cloth simulation -- delete dist between triangles constraint
...
int cloth_bvh_copy_history(ClothModifierData *clmd)
{
  Cloth *cloth = clmd->clothObject;
  BVHTree *cloth_bvh = cloth->bvhtree;
  BLI_bvhtree_copy_history_bv(cloth_bvh);
  return 0;
}

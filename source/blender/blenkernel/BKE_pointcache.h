...
/**
 * Restore disk cache to memory cache.
 */
void BKE_ptcache_restore_bake(struct PTCacheID *pid);

/**
 * Delete baked disk files manually.
 */
void BKE_ptcache_delete_bake_manually(struct PTCacheID *pid);
